...
klass={
  ...
  :darkknight=>%w[
    ...
    #20+黑暗侵蝕:開啟後範圍(10*lv)+0.05*maxhp絕對傷害(skl_vamp)#fire_circle
  ...
  :archer=>%w[
    ...
    #20+旋風護盾:每11秒自動產生(20*lv)+1.2*mdef魔法護盾持續s秒#soul_of_Ittetsu

    #20+疾風祝福:開啟後回復(20*lv)+0.2*matk生命並增加(40+4*lv)%攻速持續t秒#boost
    #20+精準命中:40%機率(1.3+0.03*lv)倍爆擊並提升(5*lv)敏捷#auto->amplify
    #20+氣流爆發:(10+lv)%機率暈0.4秒額外(25*lv)傷害#auto->amplify
    #20+無形之箭:弓箭可穿透(1+0.25*lv)敵人並提升弓箭速度(lv)#auto->amplify

    #20+望風披靡:射出可以造成(40*lv)+0.8*matk魔法傷害並沉默2.5秒的弓箭#magic_arrow
